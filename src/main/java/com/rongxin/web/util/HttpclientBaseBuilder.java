 ...
 *
 * @author duan ps : PoolingHttpClientConnectionManager和CloseableHttpClient:ThreadSafe,
  ...
  private static CloseableHttpClient initHttpClient() {
    ...
    try {
      ...
      HttpClientBuilder httpClientBuilder = HttpClients.custom()
          .setConnectionManager(httpClientConnectionManager).setDefaultCookieStore(cookieStore);
