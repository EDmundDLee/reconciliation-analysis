...
public class HttpUtils extends HttpclientBaseConfig {
  ...
  public static JSONObject doPost(String url, String jsonFormString) throws Exception {
    ...
    RequestConfig requestConfig =
        RequestConfig.custom().setSocketTimeout(30 * 1000).setConnectTimeout(30 * 1000).build();// 设置请求和传输超时时间
  ...
  public static String doPostForm(String url, Map<String, String> params)
    ...
    log.info("POST请求内容：{}", JSONObject.toJSONString(params));
    return getDataByForm(url, params, 30000, 30000);
  }
  ...
  public static void main(String[] args) throws Exception {
    //请求路径
   // String url = "https://test-userapp.api.loan.cacfintech.com/api/v1.0/short/video/group/v2/list";
    String url = "https://test-userapp.api.loan.cacfintech.com/api/v1.0/short/video/user/info";

    //请求参数
    //String jsonStr = "{ \"tId\": \"638870ab3c4ae7a6977a59a1\"}";
    String jsonStr = "{ \"_id\": \"6388744c90b828a795c60d09\"}";

    //密钥
    String key = "61B9AE7366F14956B381FE07F565F2F8";
    //封装数据
    Map<String, String> map =  new HashMap<>();
    map.put("encryptData", Sm4Util.encryptEcb(key,jsonStr));
    System.out.println(doPostForm(url,map));
    //请求并获取响应结果
    JSONObject response = JSONObject.parseObject(doPostForm(url,map));
    System.out.println(Sm4Util.decryptEcb(key,String.valueOf(response.get("encryptResult"))));
