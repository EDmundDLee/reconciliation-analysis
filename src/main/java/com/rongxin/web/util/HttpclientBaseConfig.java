...
public class HttpclientBaseConfig extends  HttpclientBaseBuilder {
  ...
  protected static final String CONTENT_TYPE_FORM =
   ...
   * @return
   */
  protected static final RequestConfig setReqConfig(Integer connectTimeout, Integer socketTimeout) {
    if (null == connectTimeout && null == socketTimeout) {
      return null;
    }
    if (null != connectTimeout && null != socketTimeout && connectTimeout <= 0
        && socketTimeout <= 0) {
      return null;
    }
   ...
   */
  protected static final UrlEncodedFormEntity setReqParams(Map<String, String> params)
      throws UnsupportedEncodingException {
