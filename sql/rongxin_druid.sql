/*
 ...
 Source Server         : 10.60.0.30
 Source Server Type    : MySQL
 Source Server Version : 50646
 Source Host           : 10.60.0.30:3306
 Source Schema         : rongxin_druid

 Target Server Type    : MySQL
 Target Server Version : 50646
 File Encoding         : 65001

 Date: 09/08/2022 15:53:54
*/
...
-- ----------------------------
-- Table structure for file_upload_share
-- ----------------------------
DROP TABLE IF EXISTS `file_upload_share`;
CREATE TABLE `file_upload_share`  (
  ...
  `groupId` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '文件组id',
  `createUser` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '上传人',
  `createDate` datetime(0) NULL DEFAULT NULL COMMENT '上传日期',
  `deptCode` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '部门编码',
  ...
  `isdel` varchar(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '是否删除(1 删除,0 未删除)',
  `standby1` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备用1',
  `standby2` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备用2',
  `standby3` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备用3',
  `standby4` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备用4',
  `standby5` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备用5',
  `fileType` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '文件类型'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '文件上传明细' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of file_upload_share
-- ----------------------------
INSERT INTO `file_upload_share` VALUES ('54d3292def054691b3c49096b0aeeac0', 'rx.txt', '4556', 'https://jnwq-land-pub-test.oss-cn-beijing.aliyuncs.com/jlncwqw/pkgs/dev/rx.txt?Expires=1975384529&OSSAccessKeyId=UjyKDL1Jo24Z6TCm&Signature=oMZUj0EMKotFfsuVLqSKtqzD3p4%3D', NULL, '1', '2022-08-09 13:55:29', '103', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 21 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '代码生成业务表字段' ROW_FORMAT = Compact;
...
-- ----------------------------
-- Table structure for rx_demo
-- ----------------------------
DROP TABLE IF EXISTS `rx_demo`;
CREATE TABLE `rx_demo`  (
  `id` int(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `demo_name` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '姓名',
  `demo_sex` int(11) NULL DEFAULT NULL COMMENT '性别',
  `demo_birth` date NULL DEFAULT NULL COMMENT '出生日期',
...
-- Records of rx_demo
-- ----------------------------
INSERT INTO `rx_demo` VALUES (2, 'd', NULL, '2022-06-29');
...
INSERT INTO `sys_config` VALUES (4, '账号自助-验证码开关', 'sys.account.captchaOnOff', 'true', 'Y', 'admin', '2022-07-28 10:49:52', '', NULL, '是否开启验证码功能（true开启，false关闭）');
INSERT INTO `sys_config` VALUES (5, '账号自助-是否开启用户注册功能', 'sys.account.registerUser', 'false', 'Y', 'admin', '2022-07-28 10:49:52', '', NULL, '是否开启注册用户功能（true开启，false关闭）');
...
INSERT INTO `sys_dept` VALUES (101, 100, '0,100', '长春总公司123', 1, '融信', '15888888888', 'ry@qq.com', '0', '0', 'admin', '2022-07-28 10:49:34', 'admin', '2022-07-29 13:27:10');
...
-- Records of sys_job
-- ----------------------------
INSERT INTO `sys_job` VALUES (1, '系统默认（无参）', 'DEFAULT', 'ryTask.ryNoParams', '0/10 * * * * ?', '3', '1', '1', 'admin', '2022-07-28 10:49:53', '', NULL, '');
INSERT INTO `sys_job` VALUES (2, '系统默认（有参）', 'DEFAULT', 'ryTask.ryParams(\'ry\')', '0/15 * * * * ?', '3', '1', '1', 'admin', '2022-07-28 10:49:53', '', NULL, '');
INSERT INTO `sys_job` VALUES (3, '系统默认（多参）', 'DEFAULT', 'ryTask.ryMultipleParams(\'ry\', true, 2000L, 316.50D, 100)', '0/20 * * * * ?', '3', '1', '1', 'admin', '2022-07-28 10:49:53', '', NULL, '');
...
) ENGINE = InnoDB AUTO_INCREMENT = 150 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统访问记录' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of sys_logininfor
-- ----------------------------
INSERT INTO `sys_logininfor` VALUES (100, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '0', '登录成功', '2022-07-28 14:17:17');
INSERT INTO `sys_logininfor` VALUES (101, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '0', '登录成功', '2022-07-28 15:24:00');
INSERT INTO `sys_logininfor` VALUES (102, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '0', '登录成功', '2022-07-29 13:26:35');
INSERT INTO `sys_logininfor` VALUES (103, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '0', '登录成功', '2022-08-02 14:13:09');
INSERT INTO `sys_logininfor` VALUES (104, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '1', '验证码已失效', '2022-08-02 15:48:16');
INSERT INTO `sys_logininfor` VALUES (105, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '0', '登录成功', '2022-08-03 09:30:15');
INSERT INTO `sys_logininfor` VALUES (106, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '0', '退出成功', '2022-08-03 09:30:40');
INSERT INTO `sys_logininfor` VALUES (107, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '0', '登录成功', '2022-08-03 09:32:36');
INSERT INTO `sys_logininfor` VALUES (108, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '0', '退出成功', '2022-08-03 09:32:41');
INSERT INTO `sys_logininfor` VALUES (109, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '0', '登录成功', '2022-08-03 09:36:53');
INSERT INTO `sys_logininfor` VALUES (110, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '0', '退出成功', '2022-08-03 09:37:01');
INSERT INTO `sys_logininfor` VALUES (111, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '1', '验证码错误', '2022-08-03 09:38:03');
INSERT INTO `sys_logininfor` VALUES (112, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '0', '登录成功', '2022-08-03 09:38:08');
INSERT INTO `sys_logininfor` VALUES (113, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '0', '退出成功', '2022-08-03 09:38:12');
INSERT INTO `sys_logininfor` VALUES (114, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '0', '登录成功', '2022-08-03 09:39:24');
INSERT INTO `sys_logininfor` VALUES (115, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '0', '退出成功', '2022-08-03 09:39:39');
INSERT INTO `sys_logininfor` VALUES (116, 'ry', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '1', '用户不存在/密码错误', '2022-08-03 09:40:25');
INSERT INTO `sys_logininfor` VALUES (117, 'ry', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '1', '验证码错误', '2022-08-03 09:40:30');
INSERT INTO `sys_logininfor` VALUES (118, 'ry', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '1', '验证码错误', '2022-08-03 09:40:33');
INSERT INTO `sys_logininfor` VALUES (119, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '1', '验证码错误', '2022-08-03 09:40:41');
INSERT INTO `sys_logininfor` VALUES (120, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '1', '验证码错误', '2022-08-03 09:40:47');
INSERT INTO `sys_logininfor` VALUES (121, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '1', '验证码错误', '2022-08-03 09:40:51');
INSERT INTO `sys_logininfor` VALUES (122, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '0', '登录成功', '2022-08-03 09:40:55');
INSERT INTO `sys_logininfor` VALUES (123, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '0', '退出成功', '2022-08-03 09:41:19');
INSERT INTO `sys_logininfor` VALUES (124, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 7', '0', '登录成功', '2022-08-03 09:41:57');
INSERT INTO `sys_logininfor` VALUES (125, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 7', '0', '退出成功', '2022-08-03 09:42:07');
INSERT INTO `sys_logininfor` VALUES (126, 'ry', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 7', '0', '登录成功', '2022-08-03 09:47:08');
INSERT INTO `sys_logininfor` VALUES (127, 'ry', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 7', '0', '退出成功', '2022-08-03 09:47:16');
INSERT INTO `sys_logininfor` VALUES (128, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '0', '登录成功', '2022-08-03 14:05:47');
INSERT INTO `sys_logininfor` VALUES (129, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '0', '退出成功', '2022-08-03 14:10:58');
INSERT INTO `sys_logininfor` VALUES (130, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '1', '验证码错误', '2022-08-03 14:14:43');
INSERT INTO `sys_logininfor` VALUES (131, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '1', '验证码错误', '2022-08-03 14:14:47');
INSERT INTO `sys_logininfor` VALUES (132, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '1', '用户不存在/密码错误', '2022-08-03 14:14:53');
INSERT INTO `sys_logininfor` VALUES (133, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '0', '登录成功', '2022-08-03 14:15:02');
INSERT INTO `sys_logininfor` VALUES (134, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '0', '退出成功', '2022-08-03 14:45:00');
INSERT INTO `sys_logininfor` VALUES (135, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '0', '登录成功', '2022-08-03 15:53:21');
INSERT INTO `sys_logininfor` VALUES (136, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '0', '登录成功', '2022-08-05 10:34:28');
INSERT INTO `sys_logininfor` VALUES (137, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '0', '登录成功', '2022-08-05 11:00:55');
INSERT INTO `sys_logininfor` VALUES (138, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-08-08 10:44:03');
INSERT INTO `sys_logininfor` VALUES (139, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '1', '验证码已失效', '2022-08-08 10:54:19');
INSERT INTO `sys_logininfor` VALUES (140, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '0', '登录成功', '2022-08-08 10:54:23');
INSERT INTO `sys_logininfor` VALUES (141, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-08-08 13:31:42');
INSERT INTO `sys_logininfor` VALUES (142, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-08-08 15:14:14');
INSERT INTO `sys_logininfor` VALUES (143, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-08-08 16:01:08');
INSERT INTO `sys_logininfor` VALUES (144, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '0', '登录成功', '2022-08-08 16:04:15');
INSERT INTO `sys_logininfor` VALUES (145, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-08-09 08:39:30');
INSERT INTO `sys_logininfor` VALUES (146, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-08-09 10:24:12');
INSERT INTO `sys_logininfor` VALUES (147, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-08-09 11:55:06');
INSERT INTO `sys_logininfor` VALUES (148, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-08-09 13:52:52');
INSERT INTO `sys_logininfor` VALUES (149, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-08-09 14:34:20');
...
INSERT INTO `sys_menu` VALUES (110, '定时任务', 2, 2, 'job', 'monitor/job/index', '', 1, 0, 'C', '0', '0', 'monitor:job:list', 'job', 'admin', '2022-07-28 10:49:38', '', NULL, '定时任务菜单');
...
INSERT INTO `sys_menu` VALUES (116, '系统接口', 3, 3, 'swagger', 'tool/swagger/index', '', 1, 0, 'C', '0', '0', 'tool:swagger:list', 'swagger', 'admin', '2022-07-28 10:49:38', '', NULL, '系统接口菜单');
...
INSERT INTO `sys_menu` VALUES (2001, '示例模块', 0, 4, 'example', NULL, NULL, 1, 0, 'M', '0', '0', NULL, 'example', 'admin', '2022-07-28 10:31:23', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2002, '示例功能', 2001, 1, 'example', 'example/demo/index', NULL, 1, 0, 'C', '0', '0', 'example:demo:list', 'example', 'admin', '2022-07-28 10:31:57', 'admin', '2022-07-28 10:33:53', '');
INSERT INTO `sys_menu` VALUES (2003, '查询', 2002, 1, '', NULL, NULL, 1, 0, 'F', '0', '0', 'example:demo:list', '#', 'admin', '2022-07-28 10:34:32', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2004, '导出', 2002, 2, '', NULL, NULL, 1, 0, 'F', '0', '0', 'example:demo:export', '#', 'admin', '2022-07-28 10:34:55', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2005, '获取信息', 2002, 3, '', NULL, NULL, 1, 0, 'F', '0', '0', 'example:demo:query', '#', 'admin', '2022-07-28 10:35:50', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2006, '新增', 2002, 4, '', NULL, NULL, 1, 0, 'F', '0', '0', 'example:demo:add', '#', 'admin', '2022-07-28 10:36:32', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2008, '编辑', 2002, 5, '', NULL, NULL, 1, 0, 'F', '0', '0', 'example:demo:edit', '#', 'admin', '2022-07-28 10:37:13', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2009, '删除', 2002, 6, '', NULL, NULL, 1, 0, 'F', '0', '0', 'example:demo:remove', '#', 'admin', '2022-07-28 10:37:52', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2016, '文件上传明细', 2001, 1, 'share', 'system/share/index', NULL, 1, 0, 'C', '0', '0', 'system:share:list', '#', 'admin', '2022-08-08 10:55:57', '', NULL, '文件上传明细菜单');
INSERT INTO `sys_menu` VALUES (2017, '文件上传明细查询', 2016, 1, '#', '', NULL, 1, 0, 'F', '0', '0', 'system:share:query', '#', 'admin', '2022-08-08 10:55:57', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2018, '文件上传明细新增', 2016, 2, '#', '', NULL, 1, 0, 'F', '0', '0', 'system:share:add', '#', 'admin', '2022-08-08 10:55:57', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2019, '文件上传明细修改', 2016, 3, '#', '', NULL, 1, 0, 'F', '0', '0', 'system:share:edit', '#', 'admin', '2022-08-08 10:55:57', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2020, '文件上传明细删除', 2016, 4, '#', '', NULL, 1, 0, 'F', '0', '0', 'system:share:remove', '#', 'admin', '2022-08-08 10:55:57', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2021, '文件上传明细导出', 2016, 5, '#', '', NULL, 1, 0, 'F', '0', '0', 'system:share:export', '#', 'admin', '2022-08-08 10:55:57', '', NULL, '');
...
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '通知公告表' ROW_FORMAT = Compact;
...
INSERT INTO `sys_notice` VALUES (10, 'd', '2', 0x3C703E643C2F703E, '0', 'admin', '2022-07-28 16:09:39', '', NULL, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 161 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '操作日志记录' ROW_FORMAT = Compact;
...
INSERT INTO `sys_role` VALUES (2, '普通角色', 'common', 2, '2', 1, 1, '0', '0', 'admin', '2022-07-28 10:49:37', 'admin', '2022-08-03 09:30:27', '普通角色');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 103, 'admin', '融信', '00', 'ry@163.com', '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2022-08-09 14:32:35', 'admin', '2022-07-28 10:49:35', '', '2022-08-09 14:34:20', '管理员');
INSERT INTO `sys_user` VALUES (2, 105, 'ry', '融信', '00', 'ry@qq.com', '15666666666', '1', '', '$2a$10$z1Jgw4AqH8iGAXE3PnL1h.Zfjw7gHkFzuj.FCJruKEKiQFz.asO/G', '0', '0', '127.0.0.1', '2022-08-03 09:45:47', 'admin', '2022-07-28 10:49:35', 'admin', '2022-08-03 09:47:08', '测试员');
